...
(document_type, document_number, "name", last_name, birth_date, address, phone_number, email)
VALUES('Cedula', '98765431', 'Ernesto', 'Perez', '1985-02-03', 'Calle alguna, siempre viva', '3229876541', 'ernesto.perez@yopmail.com');
INSERT INTO biblioteca.user
(document_type, document_number, "name", last_name, birth_date, address, phone_number, email)
VALUES('Cedula', '74125896', 'Juan Manuel', 'Gomez Peralta', '1978-12-13', 'Bogotá D.C. Cedritos', '3116549872', 'juan.peralta@yopmail.com');
INSERT INTO biblioteca.user
(document_type, document_number, "name", last_name, birth_date, address, phone_number, email)
VALUES('Cedula', '19654321', 'Monica', 'Hernandez', '1989-07-07', 'Calle 45-98, Casa 158, conjunto Rosales', '3228569747', 'monica.hernandez@gmail.com');


/* Data biblioteca.book */
INSERT INTO biblioteca.book
(isbn, "name", author, edition)
VALUES('8441532109', 'Código limpio / Clean code: Manual de estilo para el desarrollo ágil de software', 'Robert C. Martin', '2012');
INSERT INTO biblioteca.book
(isbn, "name", author, edition)
VALUES('8420541095', 'Uml para programadores Java', 'Robert Martín', '1 ed');
INSERT INTO biblioteca.book
(isbn, "name", author, edition)
VALUES('8418040505', 'Lo que los libros de Historia del Arte no quieren que sepas', 'Blanca Guilera Puig', '2024');
INSERT INTO biblioteca.book
(isbn, "name", author, edition)
VALUES('8499082475', 'El nombre del viento', 'Patrick Rothfuss', '2018');


/* Data biblioteca.loans */
INSERT INTO biblioteca.loans
(user_id, book_id, loan_date, estimated_date_return, return_date)
VALUES(1, 1, '2024-09-04', '2024-09-07', '2024-09-07');